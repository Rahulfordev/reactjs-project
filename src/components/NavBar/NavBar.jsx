...
function NavBar() {
  ...
  return (
    <div className="relative max-w-[1380px] mx-auto bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8 h-[100px]">
        ...
        <div className="hidden grow items-start lg:flex">
          <ul className="ml-12 inline-flex space-x-5">
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
